...
it('should render a default Column', () => {
  const wrapper = enzyme.shallow(<Col>Test</Col>);
...
it('should render column with all size breakpoints', () => {
  ...
  const wrapper = enzyme.shallow(col);
  expect(wrapper).toMatchSnapshot();
});

it('should render specified width column', () => {
  const wrapper = enzyme.shallow(<Col tiny={3}>Test</Col>);
  expect(wrapper).toMatchSnapshot();
});

// Prop Tests
it('should have customized class name', () => {
  const wrapper = enzyme.shallow(<Col className="test">Test</Col>);
...
it('should throw error for range', () => {
  try {
    enzyme.shallow(<Col className="test" tiny={13}>Test</Col>);
  } catch (e) {

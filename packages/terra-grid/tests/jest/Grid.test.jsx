...
it('should render a default Grid', () => {
  const wrapper = enzyme.shallow(<Grid><Grid.Row><Grid.Column>Test</Grid.Column></Grid.Row></Grid>);
  expect(wrapper).toMatchSnapshot();
});

// Prop Tests
it('should contain customized class name', () => {
  const wrapper = enzyme.shallow(<Grid className="test"><Grid.Row><Grid.Column>Test</Grid.Column></Grid.Row></Grid>);

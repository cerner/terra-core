...
module.exports = resizeTo(['medium'], {
  'Displays the time input with default props': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-default`);
  ...
  'Displays the time input with a default time': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-default-time`);
  ...
  'Ignores invalid times that are passed into a timepicker': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-invalid-date`);
  ...
  'Triggers onChange for time-input for key entry': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-on-change`);
    browser.click('#timeInput input[name="terra-time-hour-time-input"]');

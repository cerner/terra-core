...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large'], {
  'Sets the fields appropriately for a morning time': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/time-input/component/time-input-twelve-hour-mobile`);
  ...
  'Sets the fields appropriately for an evening time': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/time-input/component/time-input-twelve-hour-mobile-time-provided`);
  ...
  'Sets the correct for element on the labels when minutes and hours have ids attached': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/time-input/component/time-input-twelve-hour-mobile-ids`);

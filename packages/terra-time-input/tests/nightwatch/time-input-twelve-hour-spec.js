...
module.exports = resizeTo(['medium'], {
  'Sets the fields appropriately for a morning time': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-twelve-hour-filled-morning`);
  ...
  'Sets the fields appropriately for an evening time': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-twelve-hour-filled-evening`);
  ...
  'Meridiem input switches to a.m. when up is pressed on the meridiem input': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-time-input/time-input/component/time-input-twelve-hour`);

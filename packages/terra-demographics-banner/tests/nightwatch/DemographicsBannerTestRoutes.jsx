...
import PostMenstrualAgeDemographicsBannerNoLabel from './PostMenstrualAgeDemographicsBannerNoLabel';
...
const routes = (
  <div>
    ...
    <Route path="/tests/demographics-banner-tests/post_menstrual_age_no_label" component={PostMenstrualAgeDemographicsBannerNoLabel} />

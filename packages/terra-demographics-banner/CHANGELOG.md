...
* Changed
  * Changed patient nickname before/after CSS parenthesis property to instead be in the string to improve screen reader user's understanding of visual presentation.
...
## 3.56.0 - (October 8, 2021)

* Changed
  * Minor dependency version bump

## 3.55.0 - (September 21, 2021)

* Changed
  * Updated WDIO screenshots due to webpack-config-terra sass upgrade.

## 3.54.0 - (August 25, 2021)

...
import DemographicsBannerWithAvatar from '../example/DemographicsBannerWithAvatar?dev-site-example';
import DemographicsBannerConfidential from '../example/DemographicsBannerConfidential?dev-site-example';
...
<DemographicsBannerWithAvatar title="Demographics Banner with Avatar" />
<DemographicsBannerConfidential title="Demographics Banner with Confidential Icon" />

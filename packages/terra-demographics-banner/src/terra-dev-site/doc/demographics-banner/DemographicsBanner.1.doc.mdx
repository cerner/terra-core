...
import DemographicsBannerWithURLProfilePhoto from '../example/DemographicsBannerWithURLProfilePhoto?dev-site-example';
...
<DemographicsBannerWithURLProfilePhoto title="Demographics Banner with URL for Photo" />

...
module.exports = resizeTo(['medium'], {
  'Opens and closes a modal correctly': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-is-open`);
  ...
  'Displays a fullscreen modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-is-fullscreen`)
      .expect.element('div[role="document"]').to.be.present;
  },

  'Displays a non-fullscreen modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-disable-close-on-esc`)
      .expect.element('div[role="document"]').to.be.present;
  },

  'Closes a modal on outside click': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-is-fullscreen`);
  ...
  'Does not close a modal on outside click when close on outside click is disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-disable-close-on-outside-click`);
    browser.expect.element('div[role="document"]').to.be.present;
  ...
  'Does not close a modal on ESC when close on ESC is disabled ': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-disable-close-on-esc`);
    browser.expect.element('div[role="document"]').to.be.present;
  ...
  'Overrides the default role value': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-override-role`)
      .expect.element('div[role="button"]').to.be.present;
  },

  'Appends a css class to the modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-append-class`)
  ...
  'Displays with a content overflow example': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-content-overflow`)
      .expect.element('#modal-overflow').to.be.present;
  },

  'Displays a modal that is focusable': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-no-focusable-content`)
  ...
  'Verifies background does not scroll when modal is open': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-content-overflow`);
  ...
  'Appends custom props': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/abstract-modal/abstract-modal-custom-props`)

...
module.exports = resizeTo(['tiny', 'huge'], {
  'Opens and closes a modal correctly': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-is-open`);
  ...
  'Displays a fullscreen modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-is-fullscreen`)
      .expect.element('div[role="document"]').to.be.present;
  },

  'Displays a non-fullscreen modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-disable-close-on-esc`)
      .expect.element('div[role="document"]').to.be.present;
  },

  'Closes a modal on outside click': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-is-fullscreen`);
  ...
  'Does not close a modal on outside click when close on outside click is disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-disable-close-on-outside-click`);
    browser.expect.element('div[role="document"]').to.be.present;
  ...
  'Does not close a modal on ESC when close on ESC is disabled ': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-disable-close-on-esc`);
    browser.expect.element('div[role="document"]').to.be.present;
  ...
  'Overrides the default role value': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-override-role`)
      .expect.element('div[role="button"]').to.be.present;
  },

  'Appends a css class to the modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-append-class`)
  ...
  'Displays with a content overflow example': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-content-overflow`)
      .expect.element('#modal-overflow').to.be.present;
  },

  'Displays a modal that is focusable': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-no-focusable-content`)
  ...
  'Verifies background does not scroll when modal is open': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-content-overflow`);
  ...
  'Displays a modal that is not scrolalble': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-scrollable-false`)
      .expect.element('#modal-scroll-false').to.be.present;
  },

  'Displays a scrollable modal': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-scrollable-true`)
      .expect.element('#modal-scroll-true').to.be.present;
  },

  'Appends custom props': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/modal/components/modal-custom-props`)

...
import BorderlessActionHeader from '../example/BorderlessActionHeader';
import BorderlessActionHeaderSrc from '!raw-loader!../../../../src/terra-dev-site/doc/example/BorderlessActionHeader';
...
const DocPage = () => (
  <DocTemplate
    ...
    examples={[
      ...
      {
        example: <BorderlessActionHeader />,
        source: BorderlessActionHeaderSrc,
      },
    ]}
    propsTables={[
      {

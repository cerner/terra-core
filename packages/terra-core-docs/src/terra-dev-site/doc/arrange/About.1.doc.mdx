...
import ArrangePropsTable from 'terra-arrange/src/Arrange?dev-site-props-table';
...
* Terra arrange support altering multiple CSS attributes without loss of function or information.
* Terra arrange support resizing to 400%.
* Terra arrange support reflow when the viewport is resized to 320x256 px without loss of information or function.

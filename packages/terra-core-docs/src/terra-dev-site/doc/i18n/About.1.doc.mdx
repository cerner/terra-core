...
import I18nDemo from './example/I18nDemo?dev-site-example';
...
[You can view a list of locales supported by Terra UI here.](https://github.com/cerner/terra-aggregate-translations/blob/main/config/i18nSupportedLocales.js)
...
## Examples
<I18nDemo title="I18nProvider Example" description="Note: This is an example of a nested I18nProvider. The site overall is an example of using an application-level I18nProvider implemented through the terra-base component." />

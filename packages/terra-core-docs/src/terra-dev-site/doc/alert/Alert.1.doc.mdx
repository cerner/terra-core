...
This component has been moved to [terra-application](https://engineering.cerner.com/terra-ui/application/terra-application/components/notification-banner) and should be imported from that package. While this is the final major version of this component we will release, this component will continue to receive minor updates until terra adopts react 17.

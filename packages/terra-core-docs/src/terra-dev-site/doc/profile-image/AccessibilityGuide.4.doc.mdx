...
- [**1.1.1 Non-text Content**](https://www.w3.org/WAI/WCAG21/quickref/#non-text-content) - Partially Supports
  - Terra Profile Image contains a meaningful alt tag. The ALT prop is listed as optional. However, it is unclear what a null value will result in code. All images or anything with role=image must have an ALT attribute.

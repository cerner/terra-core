...
The Profile Image component represents an account or profile across the platform. A Profile Image visually associates a user’s, patient’s, or customer’s image with personalized content.
...
> - Engineers must apply an alt prop for meaningful images or __SOMETHING YET TO BE DETERMINED BY TERRA TEAM FOR DECORATIVE IMAGE___

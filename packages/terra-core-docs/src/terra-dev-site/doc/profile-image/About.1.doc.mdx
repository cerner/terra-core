...
import ProfileImageHigherOrderComp from './example/ProfileImageHigherOrderComp?dev-site-example';
...
<ProfileImageFit />
<ProfileImageVariant />
<ProfileImageHigherOrderComp title="Profile Image Joining Higher Order Components" />

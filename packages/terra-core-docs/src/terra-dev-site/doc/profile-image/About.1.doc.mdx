...
import ProfileImagePlaceholderFallback from './example/ProfileImagePlaceholderFallback?dev-site-example';
import ProfileImageVariant from './example/ProfileImageVariants?dev-site-example';
import ProfileImageHigherOrderComponent from './example/ProfileImageHigherOrderComponent?dev-site-example';

import ProfileImagePropsTable from 'terra-profile-image/lib/ProfileImage?dev-site-props-table';
...
## Examples
<ProfileImageDefault title="Basic Profile Image" />
<ProfileImagePlaceholderFallback title="Placeholder Fallback Examples" />
<ProfileImageFit />
<ProfileImageVariant />
<ProfileImageHigherOrderComponent />

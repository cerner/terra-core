...
The terra hyperlink component allows linking to other web pages, files, locations within the same page, email addresses, or any other URL using a traditional anchor `<a>` element with an `href` attribute for URL routing.

...
import ContentContainerFillWithoutInteractiveElements from './example/ContentContainerFillWithoutInteractiveElements?dev-site-example';
import ContentContainerFillWithInteractiveElements from './example/ContentContainerFillWithInteractiveElements?dev-site-example';
...
<ContentContainerFillWithoutInteractiveElements title = "Fill container without interactive elements"/>
<ContentContainerFillWithInteractiveElements title = "Fill container with interactive elements"/>

...
As a best practice to ensure proper page structure, the header attribute is recommended to have text within `<h3>` tag  and the footer attribute is recommended to have text within `<p>` tag 

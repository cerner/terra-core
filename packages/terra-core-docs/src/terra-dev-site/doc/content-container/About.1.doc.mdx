...
import ContentContainerWithoutInteractiveElementsLight from './example/ContentContainerWithoutInteractiveElementsLight?dev-site-example';
...
<ContentContainerWithoutInteractiveElementsLight title="Standard Container without Interactive elements (Light theme)"/>
<ContentContainerWithoutInteractiveElementsDark title="Standard Container without Interactive elements (Dark theme)"/>

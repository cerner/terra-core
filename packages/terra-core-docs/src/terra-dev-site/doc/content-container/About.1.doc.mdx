...
As a best practice to ensure proper page structure, the header attribute should have text within heading tag (h3) and the footer attribute should have text within paragraph tag (p)

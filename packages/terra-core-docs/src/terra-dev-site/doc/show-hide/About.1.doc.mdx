...
<Notice variant="caution" ariaLevel="3">
  ...
  This component is not recommended for ios-based mobile applications due to VoiceOver focus limitations with Show Hide. Consider using Terra Toggle Button for mobile applications. 

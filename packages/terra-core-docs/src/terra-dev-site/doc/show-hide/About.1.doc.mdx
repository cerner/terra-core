...
## Examples
<DefaultShowHide title="Default ShowHide with one paragraph content" description="For a single paragraph content, wrap the hidden portion in a  <span>, then pass a ref to it as focusRef prop:" />

...
import ProgressivePaginatorWithFusionAnchorStyleExample from './example/ProgressivePaginatorWithFusionAnchorStyleExample?dev-site-example';
...
<ProgressivePaginatorWithFusionAnchorStyleExample />

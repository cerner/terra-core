...
import ProgressivePaginatorWithAnchorStyleExample from './example/ProgressivePaginatorWithAnchorStyleExample?dev-site-example';
...
<ProgressivePaginatorWithAnchorStyleExample />

...
* Supports disabling of the search field.
* Supports disabling the Auto Formatting of entered search text. 
* Supports numeric filtering when search text is entered. 
* Supports programatically setting the search text to a certain value.  

...
import SearchFieldWithDefaultLabel from './example/SearchFieldWithDefaultLabel?dev-site-example';
import SearchFieldWithCustomLabel from './example/SearchFieldWithCustomLabel?dev-site-example';
...
## Examples
<SearchFieldBasic />
<SearchFieldWithDefaultLabel />
<SearchFieldWithCustomLabel />

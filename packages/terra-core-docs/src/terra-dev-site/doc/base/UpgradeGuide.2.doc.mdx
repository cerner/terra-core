...
Terra-base v5.x depends on terra-i18n v4.x. It is recommended to [review the terra-i18n v3 to v4 upgrade guide](https://github.com/cerner/terra-core/blob/main/packages/terra-i18n/docs/UPGRADEGUIDE.md) when updating terra-base to v5.

...
Informative images must have text alternatives that describe the information or function represented by them. To ensure that images can be used by people with various disabilities.

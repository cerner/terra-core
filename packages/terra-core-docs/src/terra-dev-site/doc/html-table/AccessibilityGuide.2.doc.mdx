...
- Most tables at Cerner will require both column and row headers to ensure tabular relationships can be understood programmatically. (DEV TO SHOW EXAMPLE OF ADDING COLUMN AND ROW HEADERS AND HOW TO ASSIGN A SECOND COLUMN AS ROW HEADER) 

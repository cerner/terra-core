  ...
  <div>  <table>
    ...
    <tbody>
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconSuccess title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconSuccessInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconAvailable title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconComplete title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconNoRisk title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconScheduled title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconRollup title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHighPriority title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconAlert title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconWarning title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconModerate title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconUnspecified title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconCritical title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconCriticalInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHazardLow title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconInformation title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconInformationInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconErrorDark title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconError title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDoNotDisturb title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconIncompleteInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconFeaturedOutlineYellow title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHelp title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHelpInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconUnexpected title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDueSoon title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconOverDue title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHigh title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHighInverse title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconLow title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconLowRisk title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconMax title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconMin title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconAbnormal title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDeviceCheck title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDeviceAlert title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDiamond title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconPharmacyReject title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconHide title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconBedAssigned title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDischargeComplete title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDischargeComingDue title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDischargeOverDue title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconDrugDrug title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconOutOfNetwork title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconStatusPositive title="icon" height='2em' width='2em' /></td>
      ...
      <tr style={{ backgroundColor: '#EEEEEE' }}>
        <td style={cellStyle}><IconStatusPositiveWhite title="icon" height='2em' width='2em' /></td>

...
The factory icon (<IconManufacturer/>) above is purely decorative. It provides an extra visual queue but is not nessicary for the user to understand that the text, _2800 Rock Creek Pkwy…_, is the address of the manufacturer.

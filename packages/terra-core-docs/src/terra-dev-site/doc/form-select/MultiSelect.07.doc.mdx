...
import TagDisabledExample from './example/multiple/TagDisabled?dev-site-example';
...
<TagDisabledExample title="Multi select with pills" description="An example of using pills to display selected items instead of tags" />

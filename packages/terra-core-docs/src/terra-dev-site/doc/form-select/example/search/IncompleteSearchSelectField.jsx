...
const SearchSelectFieldExample = () => (
  <SearchSelectField required isIncomplete label="T-shirt size" placeholder="Select a size" ariaLabel="Select a size" selectId="tshirt-size-field-1" className={cx('form-select')}>

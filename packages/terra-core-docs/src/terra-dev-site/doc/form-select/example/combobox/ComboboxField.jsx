...
const ComboboxFieldExample = () => (
  <ComboboxField selectAttrs={{ 'aria-label': 'Testing label Text' }} label="T-shirt size" placeholder="Select a size" selectId="tshirt-size-field-1" className={cx('form-select')}>

...
const ComboboxFieldExample = () => (
  <ComboboxField required isIncomplete label="T-shirt size" placeholder="Select a size" ariaLabel="Select a size" selectId="tshirt-size-field-2" className={cx('form-select')}>

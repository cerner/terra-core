...
A convenience wrapper assembling a [terra-form-select SingleSelect](https://github.com/cerner/terra-core/tree/main/packages/terra-form-select/lib/SingleSelect.jsx) within a [terra-form-field](https://github.com/cerner/terra-core/tree/main/packages/terra-form-field).

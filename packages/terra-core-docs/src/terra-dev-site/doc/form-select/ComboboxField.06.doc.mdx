...
import ComboboxFieldPropsTable from 'terra-form-select/lib/ComboboxField?dev-site-props-table';

<Badge />

# Terra Form Combobox Field

A convenience wrapper assembling a [terra-form-select Combobox](https://github.com/cerner/terra-core/tree/main/packages/terra-form-select/lib/Combobox.jsx) within a [terra-form-field](https://github.com/cerner/terra-core/tree/main/packages/terra-form-field).

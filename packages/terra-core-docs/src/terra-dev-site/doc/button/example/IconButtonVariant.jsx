...
import DecoIconEdit from 'terra-icon/lib/icon/decorative/IconEdit';
...
const ButtonVariant = () => (
  <div>
    ...
    <IconButton text="Utility" variant="utility" icon={<DecoIconEdit />} iconType={IconTypes.DECORATIVE} className={cx('button')} />
  </div>
);

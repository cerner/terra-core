...
const IconHeightWidth = () => (
  <div>
    ...
    <IconAlert title="Alert icon" id="icon-height-50-width-50" height="50" width="50" />
    <h3>Height and Width are 5em</h3>
    <IconAlert title="Alert icon" id="icon-height-5em-width-5em" height="5em" width="5em" />
    <h3>Container font size is 5em</h3>
    <div className={cx('icon-wrapper')}>
      <IconAlert title="Alert icon"/>
    </div>
    <h3>Height of 5em</h3>
    <IconAlert title="Alert icon" id="icon-height-5em" height="5em" />
    <h3>Width of 5em</h3>
    <IconAlert title="Alert icon" id="icon-width-5em" width="5em" />
  </div>
);

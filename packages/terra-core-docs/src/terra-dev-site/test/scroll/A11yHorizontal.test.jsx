...
class DefaultScroll extends React.Component {
  ...
  toggleScroll() {
    if (this.scrollNode) {
      this.scrollNode.scrollLeft = this.scrollNode.scrollLeft > 0 ? 0 : 1000;
    }
  }
      ...
      <div>
        ...
        <div className={cx('overflow-wrapper')}>
          <Scroll id="scroll-test" refCallback={this.setNode}>
            <p className={cx('paragraph-x-wrapper')}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis facilisis dapibus erat,
            ...
            In maximus nunc tempus magna iaculis porttitor. In maximus nunc tempus magna iaculis porttitor. In maximus nunc tempus magna iaculis porttitor. <button type="button">Focus Me!</button></p>
          </Scroll>
        </div>
      </div>
    );

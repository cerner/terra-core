...
class ButtonGroupSingleSelectWithNoSelectedItem extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        ...
        <ButtonGroup
          id="button-group-single-select-with-no-selected-item"
...
export default ButtonGroupSingleSelectWithNoSelectedItem;

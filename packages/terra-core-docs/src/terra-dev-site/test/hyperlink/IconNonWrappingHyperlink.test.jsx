...
export default () => (
  <div role="main" id="link-example">
    ...
    <p>
      Example of a hyperlink inside some content that will wrap. With this, the icon should not wrap onto a separate line without the link text. I am a
      {' '}
      <HyperlinkButton text="Document hyperlink" onClick={() => {}} variant="document" />
      {' '}
      that is forced to wrap due to space constraints. My icon wraps with me.
    </p>
    <hr />
    <p>
      {atvero}{' '}<Hyperlink text={loremipsum} href="https://www.cerner.com" variant="document" />{' '}{atvero}
    </p>
    <p>
      {atvero}{' '}<HyperlinkButton text={loremipsum} onClick={() => {}} variant="document" />{' '}{atvero}
    </p>
  </div>
);

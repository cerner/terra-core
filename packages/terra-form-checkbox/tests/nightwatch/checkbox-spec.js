...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default Checkbox': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/default-checkbox`);
    browser.expect.element('#default').to.be.present;
  },

  'Displays a disabled Checkbox': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/disabled-checkbox`);
  ...
  'Displays a checkbox with a hidden label': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/hidden-label-checkbox`);
  ...
  'Displays a populated Checkbox with correct label, help message, and choices': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/populated-checkbox`);
  ...
  'Displays a long text Checkbox': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/long-text-checkbox`);
  ...
  'Displays three Checkboxes. First checkbox defaults to checked': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-checkbox/multiple-checkboxes`);

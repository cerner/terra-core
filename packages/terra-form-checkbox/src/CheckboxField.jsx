...
const CheckboxField = (props) => {
  ...
  console.log('hello_00 ==>',isSafariBrowser,navigator.userAgent,navigator.userAgent.indexOf('Chrome'),navigator.userAgent.indexOf('Safari'),navigator.userAgent.indexOf('Edg'),navigator.userAgent.indexOf('Edg') !== -1);

...
import ActiveBreakpointProviderExample from '../example/ActiveBreakpointProviderExample?dev-site-example';
import MixinsExample from '../example/MixinsExample?dev-site-example';
...
[View component source code](https://github.com/cerner/terra-core/tree/master/packages/terra-breakpoints)

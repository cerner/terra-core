...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a field with a label': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-field/field-combinations`);
  ...
  'Label remains hidden when Field is invalid': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-field/field-interactive-invalid`);
  ...
  'Displays inline field correctly': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/form-field/field-inline`);
  ...
  'Displays a default Field with the correct text wrapping': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/form-field/field-text-wrap`)

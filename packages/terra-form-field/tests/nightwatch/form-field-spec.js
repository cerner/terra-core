...
module.exports = resizeTo(['medium'], {
  'Displays a field with a label': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-form-field/form-field/field-combinations`);
  ...
  'Label remains hidden when Field is invalid': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-form-field/form-field/field-interactive-invalid`);
  ...
  'Displays inline field correctly': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-form-field/form-field/field-inline`);
  ...
  'Displays a default Field with the correct text wrapping': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-form-field/form-field/field-text-wrap`)

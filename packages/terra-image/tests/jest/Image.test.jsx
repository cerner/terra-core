...
it('should render a default component with decorative image attributes', () => {
  const wrapper = enzyme.shallow(<Image src="" alt=" " />);
...
it('should render a default image component with a specified height and width', () => {
  const wrapper = enzyme.shallow(<Image src="" height="200" width="300" alt="default image" />);
...
it('should render a rounded image component', () => {
  const wrapper = enzyme.shallow(<Image src="" variant="rounded" alt="rounded image" />);
...
it('should render a circle image component', () => {
  const wrapper = enzyme.shallow(<Image src="" variant="circle" alt="circle image" />);
...
it('should render a thumbnail image component', () => {
  const wrapper = enzyme.shallow(<Image src="" variant="thumbnail" alt="thumbnail image" />);
...
it('should render a circle image component with fluid behavior', () => {
  ...
  const wrapper = enzyme.shallow(<div style={imagecontainerStyle1}>{image}</div>);
  expect(wrapper).toMatchSnapshot();
...
it('should render an image with the supplied onLoad function', () => {
  const onLoadFunc = () => {};
  const wrapper = enzyme.shallow(<Image src="" alt=" " onLoad={onLoadFunc} />);
...
it('should render an image with the supplied onError function', () => {
  const onErrorFunc = () => {};
  const wrapper = enzyme.shallow(<Image src="" alt=" " onError={onErrorFunc} />);
...
it('should render a hidden src image and a visible placeholder image', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt=" " height="75" width="75" placeholder={<div>placeholder text</div>} />);
  expect(wrapper).toMatchSnapshot();
});

/* Src image successfully loaded */
it('should render the src image', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt="profile" height="75" width="75" placeholder={<div>placeholder text</div>} />);
...
it('should render the placeholder image', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt="avatar" height="75" width="75" placeholder={<div>placeholder text</div>} />);
...
it('should ignore provided role and render image with default decorative image role', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt=" " role="link" height="75" width="75" />);
  expect(wrapper).toMatchSnapshot();
});
...
it('should ignore Aria and title attribute for decorative image', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt=" " aria-label="example-link" title="link-example" role="link" height="75" width="75" />);
  expect(wrapper).toMatchSnapshot();
});

/* Ignores decorative roles passed for informative images */
it('should render image without decorative image role', () => {
  const wrapper = enzyme.shallow(<Image src="profile.jpg" alt="profile image" role="presentation" height="75" width="75" />);
  expect(wrapper).toMatchSnapshot();
});

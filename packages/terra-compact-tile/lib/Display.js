...
var Display = function Display(_ref) {
  ...
  var displayClassNames = (0, _classnames2.default)(['terra-CompactTile-display', className]);

  var textClassNames = (0, _classnames2.default)(['terra-CompactTile-text', { 'terra-CompactTile-text--isTruncated': isTruncated }, _defineProperty({}, 'terra-CompactTile-text--' + textStyle, textStyle)]);

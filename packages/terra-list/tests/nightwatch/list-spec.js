...
module.exports = resizeTo(['medium'], {
  'Displays a default list': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-list/list/list/default-list`)
  ...
  'Displays a divided list': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-list/list/list/items-divided-list`);
    browser.expect.element('ul').to.have.attribute('class').which.contains('divided');
  },

  'Displays a list with one item': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-list/list/list/list-one-item`)
      .assert.elementPresent('ul');
  },

  'Displays a list with no items': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-list/list/list/list-no-items`)
      .assert.elementPresent('ul');
  },
});

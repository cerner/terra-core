...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a selectable list': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/list/selectable-list/default-selectable-list`)
  ...
  'Triggers onChange for a selectable list': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/on-change-selectable-list`);
  ...
  'Triggers onChange for disabled unselected': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/disable-unselected-selectable-list`);
  ...
  'Displays items in the selectable list with a chevron from hasChevrons prop': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/chevron-selectable-list`);
    browser.expect.element('[class*="list-item"] span').to.have.attribute('class').which.contains('chevron');
  },

  'Displays chevron selectable list with one non-chevron item': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/single-non-chevron-selectable-list`);
    browser.expect.element('[class*="list-item"] span').to.have.attribute('class').which.contains('chevron');
  },

  'Displays selectable list with one chevron item': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/single-chevron-selectable-list`);
    browser.expect.element('[class*="list-item"] span').to.have.attribute('class').which.contains('chevron');
  },

  'Displays items in the selectable list divided': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/items-divided-selectable-list`);
  ...
  'Displays only one selected item in the selectablelist': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/preselected-item-selectable-list`);
  ...
  'Displays a non-selectable item in the selectable list': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/list/selectable-list/non-selectable-item-selectable-list`);
    browser.expect.element('#example-list [class*="list-item"]:nth-child(3)').to.have.attribute('class').which.not.contains('is-selectable');
  ...
  'Displays a selectable list with one item': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/list/selectable-list/one-item-selectable-list`)
      .assert.elementPresent('ul');
  },

  'Displays a selectable list with no items': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/list/selectable-list/no-items-selectable-list`)
      .assert.elementPresent('ul');
  },

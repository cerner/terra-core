...
terra-html-table provides several different components for building semantic tables:
...
<Table isStriped={false}>
  <Header>
    <HeaderCell key="NAME">Name</Table.HeaderCell>
    <HeaderCell key="ADDRESS" sort="asc">Address</Table.HeaderCell>
    <HeaderCell key="PHONE_NUMBER">Phone Number</Table.HeaderCell>
  </Header>
  <Body>
    <Row key="PERSON_0">

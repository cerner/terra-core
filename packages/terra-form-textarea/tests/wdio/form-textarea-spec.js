  ...
  describe('default', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-form-textarea-error-focus-animation-background-image': 'linear-gradient(to bottom, #ff232a, #ff232a)',
        ...
        '--terra-form-textarea-error-focus-keyboard-animation-background-size': '100% 2px',
        ...
        '--terra-form-textarea-focus-animation-background-image': 'linear-gradient(to bottom, #6553e5, #6553e5)',
        '--terra-form-textarea-focus-start-background-size': '0 2px',
        ...
        '--terra-form-textarea-focus-keyboard-animation-background-size': '100% 2px',
  ...
  describe('Props Populated', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-form-textarea-error-focus-keyboard-border-style': 'solid',
        '--terra-form-textarea-error-focus-keyboard-border-width': '2px',
        '--terra-form-textarea-error-focus-keyboard-ltr-box-shadow': 'none',
        '--terra-form-textarea-error-focus-keyboard-rtl-box-shadow': 'none',
        '--terra-form-textarea-error-focus-keyboard-opacity': '1',
        '--terra-form-textarea-error-hover-border-color': '#ff232a',
        '--terra-form-textarea-error-hover-border-style': 'solid',
        '--terra-form-textarea-error-hover-border-width': '2px',
        ...
        '--terra-form-textarea-focus-keyboard-border-style': 'solid',
        '--terra-form-textarea-focus-keyboard-border-width': '2px',
        '--terra-form-textarea-focus-keyboard-box-ltr-shadow': 'none',
        '--terra-form-textarea-focus-keyboard-box-rtl-shadow': 'none',
        '--terra-form-textarea-focus-keyboard-opacity': '1',
        '--terra-form-textarea-hover-border-color': '#337b33',
        '--terra-form-textarea-hover-border-style': 'solid',
        '--terra-form-textarea-hover-border-width': '2px',
  ...
  describe('Invalid', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-form-textarea-focus-keyboard-border-style': 'solid',
        '--terra-form-textarea-focus-keyboard-border-width': '2px',
        '--terra-form-textarea-focus-keyboard-ltr-box-shadow': 'none',
        '--terra-form-textarea-focus-keyboard-rtl-box-shadow': 'none',
        '--terra-form-textarea-focus-keyboard-opacity': '1',
        '--terra-form-textarea-hover-border-color': '#337b33',
        '--terra-form-textarea-hover-border-style': 'solid',
        '--terra-form-textarea-hover-border-width': '2px',

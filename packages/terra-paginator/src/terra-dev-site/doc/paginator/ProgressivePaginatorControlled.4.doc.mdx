...
import ControlledInfiniteProgressivePaginatorExample from '../example/ControlledInfiniteProgressivePaginatorExample?dev-site-example';
...
<ControlledInfiniteProgressivePaginatorExample />

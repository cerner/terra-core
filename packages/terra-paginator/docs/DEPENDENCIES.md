...
| terra-dialog | ^1.24.0 | ^16.2.0 | Dialogs are temporary views that can be used in a myriad of ways. Dialogs have the ability to alert users to act on critical information. In doing so, Dialogs may allow users to avoid destructive decisions, and also extend user workflows without disorienting the user. |
...
| Dependency | Version | React Version | Description |
|-|-|-|-|
| terra-props-table | ^2.16.0 | ^16.2.0 | terra-props-table |

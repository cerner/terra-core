...
| terra-dialog | ^1.19.0 | ^16.2.0 | Dialogs are temporary views that can be used in a myriad of ways. Dialogs have the ability to alert users to act on critical information. In doing so, Dialogs may allow users to avoid destructive decisions, and also extend user workflows without disorienting the user. |
| terra-doc-template | ^1.11.0 | ^16.2.0 | Provides an adjustable template for documentation pages. |
| terra-form-input | ^1.18.0 | ^16.2.0 | Element for building out inputs in a form. |
| terra-icon | ^2.18.0 | ^16.2.0 | terra-icon |
| terra-list | ^2.19.0 | ^16.2.0 | terra-list |

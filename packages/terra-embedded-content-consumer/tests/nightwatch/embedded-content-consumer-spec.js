...
module.exports = resizeTo(['medium'], {
  'Displays a provider embedded in the consumer that contains title text.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/basic-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/basic-provider';
  ...
  'Displays a provider embedded in the consumer expanded to fill the parent.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/fill-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/fill-provider';
  ...
  'Displays a provider embedded in the consumer that triggers after initialization is complete.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/on-ready-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/on-ready-provider';
  ...
  'Displays a provider embedded in the consumer that triggers a custom event.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/custom-event-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/custom-event-provider';
  ...
  'Displays a provider embedded in the consumer that triggers multiple custom event.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/custom-events-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/custom-events-provider';
  ...
  'Displays the consumer life cycle status.': (browser) => {
    const consumerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/consumers/data-status-consumer';
    const providerSrc = '#/raw/tests/terra-embedded-content-consumer/embedded-content-consumer/providers/data-status-provider';

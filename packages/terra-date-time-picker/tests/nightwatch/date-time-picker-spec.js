...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays the DateTimePicker with default props': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-default`);
  ...
  'Displays the DateTimePicker with a default date only': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-default-date-only`);
  ...
  'Displays the DateTimePicker with a default date and time': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-default-date-time`);
  ...
  'Displays the Time Clarification dialog': (browser) => {
    if (includesTZ) {
      browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-dst`);
  ...
  'Triggers onChange when a valid date and time value is entered': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-on-change`);
  ...
  'Triggers onChangeRaw when a date or time value is changed': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-on-change-raw`);
  ...
  'Displays the DatePicker with excluded dates being disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-exclude-dates`);
  ...
  'Displays the DatePicker with filtered dates being disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-filter-dates`);
  ...
  'Displays the DatePicker with include dates being enabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-include-dates`);
  ...
  'Displays the DatePicker inside the modal manager and dismisses after selecting a date': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-inside-modal`);
  ...
  'Displays the DateTimePicker with custom date input attributes': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-date-input-attributes`);
    browser.expect.element('input[name="terra-date-input"]').to.be.present;
  ...
  'Displays the DateTimePicker with custom time input attributes': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-time-input-attributes`);
    browser.expect.element('input[name="terra-time-hour-input"]').to.be.present;
  ...
  'Clears the default date and time on calendar button click when the default date is excluded': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-default-date-excluded`);
  ...
  'Clears the default date and time on date input focus when the default date is out of range': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-time-picker/components/date-time-picker-default-date-out-of-range`);

...
| Dependency | Version | React Version | Description |
|-|-|-|-|
| terra-icon | ^2.30.0 | ^16.4.2 | The terra-icon component is used to visually represent a literal or symbolic object intended to initiate an action, communicate a status, or navigate the workflow. |

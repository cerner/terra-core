...
module.exports = resizeTo(['medium'], {
  'Displays a default text component': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/default-text`);
  ...
  'Displays a text component with a set color': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/text-color`);
  ...
  'Displays a text component with a set font size': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/text-font-size`);
  ...
  'Displays a text component with set italics': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/text-italics`);
  ...
  'Displays a text component with set hidden visibility': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/text-visually-hidden`);
  ...
  'Displays a text component with all visual props set': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/text/text-visual-props`);

...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large', 'huge', 'enormous'], {
  'Displays a default SlideGroup with the a few items': (browser) => {
    ...
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.have.css('display').which.equals('none');
  ...
  'Displays a SlideGroup with one item': (browser) => {
    ...
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.not.have.attribute('aria-hidden');
  ...
  'Increments a non-animated SlideGroup': (browser) => {
    ...
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.not.have.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').text.to.contain('Slide 1');

    browser.click('#increment-1');

    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.have.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(2)').to.have.not.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(2)').text.to.contain('Slide 2');
  },

  'Decrements a non-animated SlideGroup': (browser) => {
    browser.click('#decrement-2');

    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(2)').to.not.be.present;
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.not.have.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').text.to.contain('Slide 1');
  },
  ...
  'Increments an animated SlideGroup': (browser) => {
    ...
    browser.waitForElementPresent('#SlideGroup > span > div[class*="slide"]:not([class*="enter-active"]):nth-child(2)', 2000);
  ...
  'Decrements an animated SlideGroup': (browser) => {
    ...
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(2)').to.not.be.present.before(2000);
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').to.not.have.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(1)').text.to.contain('Slide 1');
  },
  ...
  'Disables content on hidden slides for a SlideGroup': (browser) => {
    ...
    browser.sendKeys('#increment-1', browser.Keys.ENTER);
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(2)').to.have.not.attribute('aria-hidden');
    browser.expect.element('#SlideGroup > span > div[class*="slide"]:nth-child(3)').to.not.be.present;
  },
});

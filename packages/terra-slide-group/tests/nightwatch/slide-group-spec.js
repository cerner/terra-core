...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default SlideGroup with the a few items': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/slide-group/default-slide-group`);
  ...
  'Displays a SlideGroup with one item': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/slide-group/one-item-slide-group`);
  ...
  'Increments a non-animated SlideGroup': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/slide-group/non-animated-slide-group`);
  ...
  'Increments an animated SlideGroup': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/slide-group/animated-slide-group`);

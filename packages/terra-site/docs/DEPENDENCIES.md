...
| terra-alert | ^1.9.1 | ^15.4.2 | The Terra Alert component is a notification banner that can be rendered in your application when there is information that you want to bring to the user's attention. The Alert component supports a number of built-in notification types that render with pre-defined colors and icons that help the user understand the severity and meaning of the notification. A custom notification type is also supported that allows your application to customize an alert that may not fit into the pre-defined types. |
...
| terra-button-group | ^1.12.1 | ^15.4.2 | terra-button-group |
...
| terra-collapsible-menu-view | ^1.2.0 | ^15.4.2 | The collapsible menu view is a mechanism that can be used in toolbar scenarios where actionable items will be displayed face-up and flex based on the space available. Any items that can not fit in the available space will be rolled into an ellipsis menu. |
...
| terra-date-picker | ^1.14.0 | ^15.4.2 | The terra-date-picker component provides users a way to enter or select a date from the date picker. |
| terra-date-time-picker | ^1.0.0 | ^15.4.2 | The DateTimePicker component has a date picker for selecting date and a time input for entering time |
...
| terra-embedded-content-consumer | ^1.6.1 | ^15.4.2 | The Embedded Content Consumer is the application component which is embedding web content within it. |
| terra-flex-container | ^0.0.0 | ^15.4.2 | The flex-container component provides a flexbox based container for aligning its content. |
...
| terra-search-field | ^1.13.0 | ^15.4.2 | A search component with a field that automatically performs a search callback after user input. |

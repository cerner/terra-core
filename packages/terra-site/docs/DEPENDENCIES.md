...
| terra-alert | ^1.5.0 | ^15.4.2 | The Terra Alert component is a notification banner that can be rendered in your application when there is information that you want to bring to the user's attention. The Alert component supports a number of built-in notification types that render with pre-defined colors and icons that help the user understand the severity and meaning of the notification. A custom notification type is also supported that allows your application to customize an alert that may not fit into the pre-defined types. |
...
| terra-badge | ^1.7.0 | ^15.4.2 | terra-badge |
...
| terra-button-group | ^1.8.0 | ^15.4.2 | terra-button-group |
| terra-card | ^1.2.0 | ^15.4.2 | Card is a basic container with some base styling to help seperate elements with different content |
...
| terra-date-picker | ^1.9.0 | ^15.4.2 | The terra-date-picker component provides users a way to enter or select a date from the date picker. |
| terra-demographics-banner | ^1.8.0 | ^15.4.2 | The demographics component is used to display demographic information about a person in a condensed, easy to read format. |
| terra-dynamic-grid | ^1.2.0 | ^15.4.2 | The terra-dynamic-grid component provides users a way to build dynamic layouts using CSS Grids. |
| terra-embedded-content-consumer | ^1.2.0 | ^15.4.2 | The Embedded Content Consumer is the application component which is embedding web content within it. |
| terra-form | ^1.7.0 | ^15.4.2 | Components for building forms |
| terra-grid | ^3.11.0 | ^15.4.2 | The grid component provides a flexbox based grid system. |
| terra-heading | ^1.8.0 | ^15.4.2 | Terra includes styling for all standard headings `h1` through `h6`, as well as styles that match the size of their respective heading. |
...
| terra-image | ^1.7.0 | ^15.4.2 | terra-image |
| terra-list | ^1.8.0 | ^15.4.2 | terra-list |
| terra-markdown | ^1.5.0 | ^15.4.2 | terra-markdown |
...
| terra-modal | ^1.8.0 | ^15.4.2 | Modals are used to display content in a layer above the app. Modals consist of an overlay and container. Higher order components can provide the modal dialog with a header, body, and close button. |
...
| terra-overlay | ^1.7.0 | ^15.5.4 | The Overlay component is a component that creates an semi-transparent overlay screen that blocks interactions with the elements underneath the display. There are two types of overlays: fullscreen and relative to its container. |
| terra-popup | ^1.7.0 | ^15.4.2 | The Terra Popup is higher order component, that launches tether positioned content, with the ability to display a dynamic arrow. |
| terra-profile-image | ^1.6.0 | ^15.4.2 | The terra-profile-image component displays an avatar image while the profile image is being loaded. If the profile image successfully loads, the avatar image is replaced with the profile image. Otherwise, the avatar image is left as is. All styling set on the profile image will be applied to the avatar image. |
| terra-progress-bar | ^1.7.0 | ^15.4.2 | terra-progress-bar |
...
| terra-search-field | ^1.8.0 | ^15.4.2 | A search component with a field that automatically performs a search callback after user input. |
| terra-slide-group | ^1.7.0 | ^15.4.2 | A component that utilizes the `react-transition-group` library to present a stack of components in an animated fashion |
| terra-slide-panel | ^1.7.0 | ^15.4.2 | terra-slide-panel |
| terra-status | ^1.8.0 | ^15.4.2 | The status component provides a customizable color indictor to signify a specific condition. |
| terra-table | ^1.8.0 | ^15.4.2 | The terra-table component provides user a way to render data in a tabular format |
| terra-text | ^1.7.0 | ^15.4.2 | Component for displaying customizable text in UI. |
| terra-theme-provider | ^1.2.0 | ^15.4.2 | The theme provider component provides a theme to Terra UI components rendered within it via CSS custom properties a.k.a CSS variables. |
| terra-time-input | ^1.8.0 | ^15.4.2 | A controlled input component for entering time. |
| terra-toggle | ^1.7.0 | ^15.4.2 | Toggle component that transitions content in and out. |
| terra-toggle-button | ^1.8.0 | ^15.4.2 | Toggle button component that transitions content in and out with the click on a button. |

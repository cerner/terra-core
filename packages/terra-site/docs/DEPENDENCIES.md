...
| terra-badge | ^1.11.1 | ^15.4.2 | terra-badge |
...
| terra-button-group | ^1.13.0 | ^15.4.2 | terra-button-group |
| terra-card | ^1.6.1 | ^15.4.2 | Card is a basic container with some base styling to help seperate elements with different content |
| terra-collapsible-menu-view | ^1.4.0 | ^15.4.2 | The collapsible menu view is a mechanism that can be used in toolbar scenarios where actionable items will be displayed face-up and flex based on the space available. Any items that can not fit in the available space will be rolled into an ellipsis menu. |
...
| terra-date-picker | ^1.16.0 | ^15.4.2 | The terra-date-picker component provides users a way to enter or select a date from the date picker. |
| terra-date-time-picker | ^1.2.0 | ^15.4.2 | The DateTimePicker component has a date picker for selecting date and a time input for entering time |
...
| terra-hookshot | ^1.2.0 | ^15.4.2 | The Terra Hookshot component positions portaled content according to target and content attachments, ensuring they stay visually connected. |
...
| terra-modal-manager | ^1.14.0 | ^15.4.2 | A Redux-backed Container component that dynamically presents components in a Terra Modal |
| terra-overlay | ^1.12.0 | ^15.5.4 | The Overlay component is a component that creates an semi-transparent overlay screen that blocks interactions with the elements underneath the display. There are two types of overlays: fullscreen and relative to its container. |
| terra-popup | ^1.14.0 | ^15.4.2 | The Terra Popup is higher order component that launches terra-hookshot positioned content with the ability to display a dynamic arrow. |
...
| terra-search-field | ^1.15.0 | ^15.4.2 | A search component with a field that automatically performs a search callback after user input. |
| terra-signature | ^0.5.0 | ^15.4.2 | A signature defined by an array of line segments. |
...
| terra-status | ^1.14.0 | ^15.4.2 | The status component provides a customizable color indictor to signify a specific condition. |
| terra-table | ^1.15.0 | ^15.4.2 | The terra-table component provides user a way to render data in a tabular format |
| terra-text | ^1.12.0 | ^15.4.2 | Component for displaying customizable text in UI. |
...
| terra-time-input | ^1.13.0 | ^15.4.2 | A controlled input component for entering time. |
| terra-toggle | ^1.11.1 | ^15.4.2 | Toggle component that transitions content in and out. |
| terra-toggle-button | ^1.14.0 | ^15.4.2 | Toggle button component that transitions content in and out with the click on a button. |

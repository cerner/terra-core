...
const StatusExamples = () => (
  <div>
    ...
    <StatusViewTemplate style={{ width: '500px' }} variant={StatusView.Opts.variants.NODATA} title="No Data" message="No data was returned">
    ...
    <StatusViewTemplate style={{ width: '500px' }} variant={StatusView.Opts.variants.ERROR} message="An exception was thrown" isGlyphHidden>
      <Button text="OK" key="1" size="medium" />
      <Button text="Cancel" key="2" size="medium" />
    </StatusViewTemplate>
    <h2 id="large">Status View:  Large Container</h2>
    <StatusViewTemplate style={{ height: '500px', width: '500px' }} variant={StatusView.Opts.variants.ERROR} message="An exception was thrown">
      <Button text="OK" key="1" size="medium" />
      <Button text="Cancel" key="2" size="medium" />
    </StatusViewTemplate>
    <h2 id="align-top">Status View:  Align Top</h2>
    <StatusViewTemplate style={{ height: '500px', width: '500px' }} isAlignedTop variant={StatusView.Opts.variants.ERROR} message="An exception was thrown">
      <Button text="OK" key="1" size="medium" />
      <Button text="Cancel" key="2" size="medium" />
    </StatusViewTemplate>
    <h2 id="glyph-small">Status View:  Glyph cannot fit</h2>
    <StatusViewTemplate style={{ height: '250px', width: '500px', overflow: 'auto' }} variant={StatusView.Opts.variants.ERROR} message="An exception was thrown">
      <Button text="OK" key="1" size="medium" />
      <Button text="Cancel" key="2" size="medium" />
    </StatusViewTemplate>
  </div>

...
class BuildYourOwnAlertExample extends React.Component {
  ...
  render() {
    const gettysburgAddress = (
      <span>
        ...
        <Toggle isOpen={!this.state.allTextShown} isAnimated>
          <Button onClick={this.handleShowMore} text="Show More" size="tiny" />
        </Toggle>
        <Toggle isOpen={this.state.allTextShown} isAnimated>
          ...
          <br /><br />
          <Button onClick={this.handleShowLess} text="Show Less" size="tiny" />
        </Toggle>
      </span>
    );
    ...
    const actionButton = this.state.showActionButton ? (<Button text="Action" size="medium" variant="emphasis" onClick={this.actionFunc} />) : undefined;
    const alertActionPropStr = this.state.showActionButton ? 'action={<Button text="Action" size="medium" variant="emphasis" onClick={this.actionFunc} />}' : '';

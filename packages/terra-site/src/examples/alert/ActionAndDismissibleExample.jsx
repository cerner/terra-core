...
class ActionAndDismissibleExample extends React.Component {
  ...
  render() {
    const alertStartTagStr = '<Alert type={Alert.Opts.Types.CUSTOM} onDismiss={this.handleDismiss} customStatusColor="orange" action={<Button text="Action" variant="primary" onClick={this.actionFunc} />} >';
    ...
    if (!this.state.isDismissed) {
      alertElem = (
        <Alert type={Alert.Opts.Types.CUSTOM} onDismiss={this.handleDismiss} customStatusColor="orange" action={<Button text="Action" variant="emphasis" onClick={this.actionFunc} />} >
          {alertText}
        </Alert>
      );
    }

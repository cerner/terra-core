  ...
  render() {
    return (
      <div style={{ height: '500px' }}>
        <Dialog header={<h1>Page {this.state.currentPage}</h1>} footer={<ProgressivePaginator onPageChange={this.changePages} selectedPage={1} totalCount={totalCount} itemCountPerPage={10} />}>
          {this.state.content}
        </Dialog>
      </div>
    );

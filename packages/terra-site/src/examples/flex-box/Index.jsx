...
const FlexBoxExamples = () => (
  <div>
    ...
    <FlexBox id="parent" style={{ border: '1px solid black' }}>
      <FlexBox id="child1" flex="0 0 40%" alignSelf="stretch" style={{ 'border-right': '1px solid black' }}>
        <span>1 Test Display that is 40% 1</span>
      </FlexBox>
      <FlexBox id="child2" flex="1 1 auto" alignSelf="stretch" style={{ 'border-right': '1px solid black' }}>

...
const TabsExamples = () => (
  <div style={{ backgroundColor: 'lightgrey' }}>
    <h2>Modular - Left Aligned Tabs</h2>
    <h3>Compact</h3>
    <TabsTemplate variant="modular-left-aligned" />
    <h3>Expanded</h3>
    <TabsTemplate variant="modular-left-aligned" tabFill />
    <h3>Icon Only</h3>
    <IconOnlyTabs variant="modular-left-aligned" />
    <h3>Fill Parent Container</h3>
    <TabsWithFilledContent variant="modular-left-aligned" fill />
  </div>
);

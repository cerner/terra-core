...
module.exports = resizeTo(['tiny', 'huge'], {
  ...
  'Displays default hookshot': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/default-hookshot`);
  ...
  'Displays in primary position when there is enough room with no attachment behavior': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-attachment-behavior-none`);
  ...
  'Displays in primary position when there is enough room with flip attachment behavior': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-attachment-behavior-flip`);
    browser.click('#position-primary');
  ...
  'Displays in primary position when there is enough room with auto attachment behavior': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-attachment-behavior-auto`);
    browser.click('#position-primary');
  ...
  'Displays with given margin between the attachment points - Middle Start Content Attachment': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-attachment-margin`);
  ...
  'Displays content pushed start by bounding container': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-bounding-container`);
  ...
  'Display the content offset correctly for dir=ltr': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-content-offset`);
  ...
  'Display the target offset correctly for dir=ltr': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-target-offset`);
  ...
  'Content is positioned and visible when isEnabled={true}': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-enabled-behaviors`);
  ...
  'Closes the hookshot content on ESC when all close behavior is present': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/hookshot/components/hookshot-close-behaviors`);

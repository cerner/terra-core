...
class ButtonAlignLeftShowHide extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        <ShowHide buttonAlign="start" preview={<p>{previewText}</p>} isOpen={this.state.isOpen} onChange={this.toggleShowHide}>
          <p>{fullText}</p>
        </ShowHide>
      </div>
    );
...
export default ButtonAlignLeftShowHide;

...
class CustomIconShowHide extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <ShowHide preview={<p>{previewText}</p>} isOpen={this.state.isOpen} onToggle={this.toggleShowHide} icon={<IconTrophy />}>
        {<p>{fullText}</p>}
      </ShowHide>
    );
  }

...
describe('RadioField', () => {
  describe('RadioField Valid', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-form-radio/form-radio/radio-field/controlled-radio-field');
    });
  ...
  describe('RadioField Interactions - Valid State with hideRequired', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-form-radio/form-radio/radio-field/hide-required-invalid-radio-field');
      browser.waitForVisible('#testing-radio-field');
      browser.click('#website-dept');
      browser.click('#ux-dept');
    });
  ...
  describe('RadioField Optional', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-form-radio/form-radio/radio-field/optional-radio-field');
    });
  ...
  describe('RadioField Hidden Legend', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-form-radio/form-radio/radio-field/hidden-legend');
    });

...
module.exports = resizeTo(['medium'], {
  ...
  'Displays a default spacer': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/default-spacer`)
  ...
  'Displays spacer with small-2 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-small-2`)
  ...
  'Displays spacer with small-1 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-small-1`)
  ...
  'Displays spacer with small margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-small`)
  ...
  'Displays spacer with medium margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-medium`)
  ...
  'Displays spacer with large margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-large`)
  ...
  'Displays spacer with large+1 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-large-1`)
  ...
  'Displays spacer with large+2 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-large-2`)
  ...
  'Displays spacer with large+3 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-large-3`)
  ...
  'Displays spacer with large+4 margin': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/spacer/spacer-large-4`)

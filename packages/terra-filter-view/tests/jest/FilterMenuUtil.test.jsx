...
import MenuUtil from '../../src/_FilterMenuUtil';
import { Variants } from '../../src/_FilterConstants';
...
describe('MenuUtil', () => {
  ...
  describe('shouldShowNoResults', () => {
    it('should return true if children is empty', () => {
      expect(MenuUtil.shouldShowNoResults({ variant: Variants.LIST }, [])).toBeTruthy();
    });

    it('should return false if children is not empty', () => {
      expect(MenuUtil.shouldShowNoResults({ variant: Variants.LIST }, ['One'])).toBeFalsy();
    });
  });

...
const SearchDisabledMultiSelectExample = () => (
  <MultiSelect placeholder="Select a color" className={cx('form-select')} isSearchDisabled>
...
export default SearchDisabledMultiSelectExample;

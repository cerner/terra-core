...
As a result of accessibility issues, the default implementation of select should no be used. It will be fully removed in a future major version bump. To achieve the same functionality the [Native Select][2] should be consumed.

[1]: https://engineering.cerner.com/terra-core/components/terra-base/base/base
[2]: https://engineering.cerner.com/terra-core/components/terra-form-select/form-select/native-select
...
- [Cross-Browser Support](https://engineering.cerner.com/terra-ui/contributing/te87rra-ui/component-standards#cross-browser-support)

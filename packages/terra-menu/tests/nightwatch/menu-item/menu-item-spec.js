...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default Menu.item': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-default`)
  ...
  'Displays a Menu.item with wrapped text': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-wrapped-text`)
  ...
  'Displays a Selectable Menu.Item': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-selectable`)
  ...
  'Displays a Menu.Item with a submenu indicator': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-sub-menu`)
  ...
  'Triggers onClick for Menu.Item': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-on-click`)
  ...
  'Disables a Menu.Item when indicated': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/menu/menu-item/menu-item-disabled`);

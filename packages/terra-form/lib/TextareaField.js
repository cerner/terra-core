...
var TextareaField = function TextareaField(_ref) {
  var cols = _ref.cols,
      ...
      value = _ref.value,
      customProps = _objectWithoutProperties(_ref, ['cols', 'defaultValue', 'error', 'help', 'inputAttrs', 'isInline', 'label', 'name', 'onChange', 'required', 'rows', 'maxLength', 'minLength', 'value']);

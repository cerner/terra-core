...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large', 'huge', 'enormous'], {
  ...
  'Displays an Icon Only Button Group': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/button-group-tests/icon-only-button-group`);
  },

  'Displays a Default variant Button Group': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/button-group-tests/default-variant-button-group`);
  ...
  'Displays a Secondary variant Button Group': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/button-group-tests/secondary-variant-button-group`);
  ...
  'Displays a Selectable Button Group': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/button-group-tests/selectable-button-group`);
    browser.expect.element('#button-group-selectable button').to.be.present;
  },

  'Triggers onChange for a Button Group': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/button-group-tests/on-change-button-group`);

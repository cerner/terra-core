Terra.describeViewports('Form-Input', ['tiny', 'large'], () => {
  it('should display valid Form Input', () => {
    browser.url('/raw/tests/cerner-terra-core-docs/form-input/default-form-input');
  ...
  it('should display invalid Form Input', () => {
    browser.url('/raw/tests/cerner-terra-core-docs/form-input/invalid-form-input');
    $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
  ...
  it('should display incomplete Form Input', () => {
    browser.url('/raw/tests/cerner-terra-core-docs/form-input/incomplete-form-input');
    $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
  ...
  it('should display invalid Form Input with incomplete', () => {
    browser.url('/raw/tests/cerner-terra-core-docs/form-input/invalid-with-incomplete-form-input');
    $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
  ...
  describe('Enabled', () => {
    ...
    it('should display enabled Form Input with value', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/value-form-input');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
  ...
  describe('Disabled', () => {
    it('should display disabled form Input non-selected', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/disabled-form-input');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
    ...
    it('should display disabled Form Input with value', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/disabled-value-input');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
  ...
  describe('InputField', () => {
    it('should display resized InputField', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/input-field-width');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
    ...
    it('should display valid InputField', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/input-field');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
    ...
    it('should display disabled InputField', () => {
      browser.url('/raw/tests/cerner-terra-core-docs/form-input/disabled-input-field');
      $('#root').moveTo({ xOffset: 0, yOffset: 700 }); // add to ensure consistent hover styles
...
Terra.describeViewports('Form-Input', ['large'], () => {
  describe('Setting Value', () => {
    before(() => browser.url('/raw/tests/cerner-terra-core-docs/form-input/setting-value-input'));

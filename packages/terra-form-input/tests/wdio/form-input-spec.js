...
describe('Form-Input', () => {
  describe('Valid', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-form-input-focus-animation-background-image': 'linear-gradient(rgba(0, 0, 255, 0.5), rgba(255, 255, 0, 0.5)',
        ...
        '--terra-form-input-focus-start-background-size': '20px 20px',
  ...
  describe('Invalid', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      testName: 'themed',
      properties: {
        '--terra-form-input-error-focus-animation-background-image': 'linear-gradient(rgba(0, 0, 255, 0.5), rgba(255, 255, 0, 0.5)',
    ...
    describe('Enabled Keyboard-Focused', () => {
      ...
      Terra.should.themeCombinationOfCustomProperties({
        ...
        properties: {
          ...
          '--terra-form-input-focus-keyboard-animation-background-size': '20px 20px',
        },
      });
    });
  });
    ...
    describe('Disabled Keyboard-Focused', () => {
      ...
      Terra.should.themeCombinationOfCustomProperties({
        ...
        properties: {
          '--terra-form-input-focus-background-color': 'red',
          '--terra-form-input-focus-border': '20rem dashed red',
          '--terra-form-input-error-focus-keyboard-animation-background-size': '20px 20px',
        },
      });
    });
  });

...
class SharedUserColorVariants extends React.Component {
  constructor(props) {
    super(props);
    this.handleOnSelect = this.handleOnSelect.bind(this);

    this.state = { colorVariant: 'neutral' };
  }
  ...
  render() {
    ...
    return (
      <div>
        <SharedUser alt="Deep Space" color={colorVariant} />
...
export default SharedUserColorVariants;

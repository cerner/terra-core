...
----------
### Fixed
* Add try-catch blocks around the Intl check to ensure errors are correctly handled if an throw is thrown. Fixes https://github.com/cerner/terra-core/issues/2820.

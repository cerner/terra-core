...
describe('I18nProvider', () => {
  ...
  describe('for snapshot tests', () => {
    it('renders a default I18nProvider', () => {
      const wrapper = enzyme.shallow(<I18nProvider locale={locale} messages={messages}><Children /></I18nProvider>);
  ...
  describe('for error handling tests', () => {
    it('throws error for missing required locale', () => {
      try {
        enzyme.shallow(<I18nProvider messages={messages}><Children /></I18nProvider>);
      } catch (e) {
    ...
    it('throws error for missing required messages', () => {
      try {
        enzyme.shallow(<I18nProvider locale={locale}><Children /></I18nProvider>);
      } catch (e) {
    ...
    it('throws error for missing required children', () => {
      try {
        enzyme.shallow(<I18nProvider locale={locale} messages={messages} />);
      } catch (e) {

...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays the DatePicker with defaulted props': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-default`);
  ...
  'Displays the DatePicker with excluded dates being disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-exclude-dates`);
    browser.click('[class*="button"]');
  ...
  'Displays the DatePicker with filtered dates being disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-filter-dates`);
    browser.click('[class*="button"]');
  ...
  'Displays the DatePicker with include dates being enabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-include-dates`);
    browser.click('[class*="button"]');
  ...
  'Displays the DatePicker with min and max dates': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-min-max`);
    browser.click('[class*="button"]');
  ...
  'Creates a hidden input with a default name atribute of "date-input" and sets the value in ISO8601 format when a valid date is entered': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-start-date`);
    browser.expect.element('[data-terra-date-input-hidden]').to.have.attribute('name').which.equals('date-input');
  ...
  'Triggers onChange when a date value is cleared': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-on-change`);
  ...
  'Triggers onChangeRaw when a date input value is changed': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-on-change-raw`);
  ...
  'Triggers onSelect when a date is selected from the picker': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-on-select`);
  ...
  'Triggers onClickOutside when clicking outside of the picker to dismiss it': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-on-click-outside`);
  ...
  'Displays the DatePicker inside the modal manager and dismisses after selecting a date': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-inside-modal`);
  ...
  'Clears the default date and time on calendar button click when the default date is excluded': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-default-date-excluded`);
  ...
  'Clears the default date and time on calendar button click when the default date is out of range': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/date-picker/components/date-picker-default-date-out-of-range`);

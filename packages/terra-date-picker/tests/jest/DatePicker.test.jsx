...
it('should render a default date input and date picker', () => {
  const datePicker = <DatePicker utcOffset={moment().utcOffset()} />;
  const wrapper = shallow(datePicker);
  expect(wrapper).toMatchSnapshot();
});

it('should render a date range', () => {
  const dateRange = <DateRange utcOffset={moment().utcOffset()} />;
...
it('should render a date picker with filtered dates', () => {
  const datePicker = <DatePicker filterDate={isWeekday} utcOffset={moment().utcOffset()} />;
  const wrapper = shallow(datePicker);
  expect(wrapper).toMatchSnapshot();
});
...
it('should render a date picker in portal', () => {
  const datePicker = <DatePicker portal utcOffset={moment().utcOffset()} />;
  const wrapper = shallow(datePicker);
  expect(wrapper).toMatchSnapshot();
});

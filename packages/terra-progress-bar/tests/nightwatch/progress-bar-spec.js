...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default progress bar': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/progress-bar/components/progress-bar-default`); // Browser computes #304FFE to rgba(48, 79, 254, 1);
  },

  'Displays tiny progress bar example': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/progress-bar/components/progress-bar-size`);
  ...
  'Displays orange progress bar example': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/progress-bar/components/progress-bar-color`)

...
describe('DynamicGrid', () => {
  ...
  it('should render a default component', () => {
    const region = enzyme.shallow(defaultRender);
    expect(region).toMatchSnapshot();
  });

  it('should render a Grid with merged attributes', () => {
    /* eslint-disable react/forbid-component-props */
    const region = enzyme.shallow(<DynamicGrid.Region className="TestClass" data-mock="data" style={{ height: '100px' }} />);
    expect(region).toMatchSnapshot();
  ...
  it('should merge classes passed in with attributes', () => {
    const region = enzyme.shallow(<DynamicGrid.Region className="TestClass" />);

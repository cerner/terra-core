...
one of the following numbers:<br /><br />
`1`, `2`, `3`, `4`, `5`, `6`
<HeadingLevels />

The `size` prop can be used to alter the default size of any `Heading` component whenever necessary. The `size` prop accepts one of the following strings:<br />
...
The `weight` prop can be used to specify the weight or boldness of the `Heading` component. Heading components default to a `font-weight` of `700`. The `weight` prop accepts one of the following numbers:<br /><br />
`200`, `400`, `700`
<HeadingWeights />

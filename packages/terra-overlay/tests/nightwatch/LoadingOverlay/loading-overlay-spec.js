...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default LoadingOverlay': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/default-loading-overlay`);
  ...
  'Displays a LoadingOverlay relative to the triggering container': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/container-loading-overlay`);
  ...
  'Displays a LoadingOverlay with a custom message': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/custom-message-loading-overlay`);
  ...
  'Displays a LoadingOverlay with an animated icon': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/animated-loading-overlay`);
  ...
  'Displays a LoadingOverlay with a light theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/light-loading-overlay`);
  ...
  'Displays a LoadingOverlay with a dark theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/dark-loading-overlay`);
  ...
  'Displays a LoadingOverlay with a clear theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/overlay/loading-overlay/clear-loading-overlay`);

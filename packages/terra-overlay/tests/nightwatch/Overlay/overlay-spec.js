...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default overlay': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/default-overlay`);
  ...
  'Displays a default Overlay relative to the triggering container': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/container-overlay`);
  ...
  'Displays a fullscreen Overlay with isScrollable prop': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/fullscreen-scrollable-overlay`);
  ...
  'Displays an Overlay relative to container with isScrollable prop': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/container-scrollable-overlay`);
  ...
  'Triggers an onRequestClose on escape keydown': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/on-request-close-overlay`);
  ...
  'Content under overlay is not clickable when Overlay is open': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/custom-content-overlay`);
  ...
  'Displays a Overlay with a light theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/light-overlay`);
  ...
  'Displays a Overlay with a dark theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/dark-overlay`);
  ...
  'Displays a Overlay with a clear theme': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/overlay/overlay/clear-overlay`);

...
* Added
   * Added `setFocusOnContent` prop to provide scroll capability for keyboard only users. (Requires Jest Snapshot updates)
...
## 3.36.1 - (January 4, 2022)

* Changed
  * Minor dependency version bump

## 3.36.0 - (November 2, 2021)

...
import UncontrolledBreakpointExample from '../example/UncontrolledBreakpointExample?dev-site-example';
...
## Examples
<BreakpointExample title="Responsive Breakpoints" />
<ResizeExample title="Responsive Resizing" />
<UncontrolledBreakpointExample title="[Deprecated] Uncontrolled Example" />

...
module.exports = resizeTo(['medium'], {
  'Displays the default element when contained within a parent of default size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/default-responsive-element`)
  ...
  'Displays the tiny element when contained within a parent of tiny size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/tiny-responsive-element`)
  ...
  'Displays the small element when contained within a parent of small size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/small-responsive-element`)
  ...
  'Displays the medium element when contained within a parent of medium size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/medium-responsive-element`)
  ...
  'Displays the large element when contained within a parent of large size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/large-responsive-element`)
  ...
  'Displays the huge element when contained within a parent of huge size': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/huge-responsive-element`)
  ...
  'Displays the correct element responsive to window size': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-responsive-element/responsive-element/window-responsive-element`);

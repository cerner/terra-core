...
it('should render a neutral button', () => {
  const button = enzyme.shallow(<Button text="neutral" />);
  expect(button).toMatchSnapshot();
});

it('should render a emphasis button', () => {
  const button = enzyme.shallow(<Button text="emphasis" variant="emphasis" />);
  expect(button).toMatchSnapshot();
});

it('should render a ghost button', () => {
  const button = enzyme.shallow(<Button text="ghost" variant="ghost" />);
  expect(button).toMatchSnapshot();
});

it('should render a de-emphasis button', () => {
  const button = enzyme.shallow(<Button text="de-emphasis" variant="de-emphasis" />);
  expect(button).toMatchSnapshot();
});

it('should render an action button', () => {
  const button = enzyme.shallow(<Button text="action" variant="action" />);
  expect(button).toMatchSnapshot();
});

it('should render a utility button', () => {
  const button = enzyme.shallow(<Button text="utility" variant="utility" />);
  expect(button).toMatchSnapshot();
});

it('should render a button with type equal to button', () => {
  const button = enzyme.shallow(<Button text="button" type="button" />);
  expect(button).toMatchSnapshot();
});

it('should render a button with type equal to reset', () => {
  const button = enzyme.shallow(<Button text="reset" type="reset" />);
  expect(button).toMatchSnapshot();
});

it('should render a button with type equal to submit', () => {
  const button = enzyme.shallow(<Button text="submit" type="submit" />);
  expect(button).toMatchSnapshot();
});

it('should render an informative icon button', () => {
  const testElement = <img alt="icon" />;
  const button = enzyme.shallow(<Button icon={testElement} isIconOnly text="isIconOnly" />);
  expect(button).toMatchSnapshot();
});

it('should render an icon and a text', () => {
  const testElement = <img alt="icon" />;
  const button = enzyme.shallow(<Button icon={testElement} text="text" />);
  expect(button).toMatchSnapshot();
});

it('should render text then an icon when reversed', () => {
  const testElement = <img alt="icon" />;
  const button = enzyme.shallow(<Button icon={testElement} text="text" isReversed />);
  expect(button).toMatchSnapshot();
});

it('should render a Button with merged attributes', () => {
  /* eslint-disable react/forbid-component-props */
  const button = enzyme.shallow(<Button className="TestClass" data-mock="data" text="text" style={{ height: '100px' }} />);
  expect(button).toMatchSnapshot();
  /* eslint-enable react/forbid-component-props */
});

it('should render as an anchor when provided an href', () => {
  const button = enzyme.shallow(<Button text="href" href="MockHref" />);
  expect(button).toMatchSnapshot();
});
...
it('should be disabled when set', () => {
  const button = enzyme.shallow(<Button isDisabled text="text" />);
...
it('should render in order of text / icon when reverse', () => {
  const testElement = <img alt="icon" />;
  const button = enzyme.shallow(<Button icon={testElement} isReversed text="text" />);
...
it('should render as an anchor tag when provided an href', () => {
  const button = enzyme.shallow(<Button href="MockHref" text="text" />);
  expect(button.is('a')).toEqual(true);
});

// Attributes
it('should merge classes passed in with attributes', () => {
  const button = enzyme.shallow(<Button className="TestClass" text="text" />);
  expect(button.prop('className')).toContain('TestClass');
});

it('should append data passed in with attributes', () => {
  const button = enzyme.shallow(<Button data-terra-button-mock="MockData" text="text" />);
  expect(button.prop('data-terra-button-mock')).toContain('MockData');
});

it('should append styles passed in with attributes', () => {
  /* eslint-disable react/forbid-component-props */
  const button = enzyme.shallow(<Button style={{ height: '100px' }} text="text" />);
  expect(button.prop('style')).toEqual({ height: '100px' });
  /* eslint-enable react/forbid-component-props */
});

it('should render an icon only button with text as a fallback title', () => {
  const button = enzyme.shallow(<Button isIconOnly text="Icon Only" />);
  expect(button).toMatchSnapshot();
});

it('should render an icon only button with a custom title', () => {
  const button = enzyme.shallow(<Button isIconOnly text="Icon Only" title="Custom Title" />);
  expect(button).toMatchSnapshot();
});

it('should render a utility button with text as a fallback title', () => {
  const button = enzyme.shallow(<Button variant="utility" text="Icon Only" />);
  expect(button).toMatchSnapshot();
});

it('should render a utility button with a custom title', () => {
  const button = enzyme.shallow(<Button variant="utility" text="Icon Only" title="Custom Title" />);
  expect(button).toMatchSnapshot();
});

it('should render a button with a title', () => {
  const button = enzyme.shallow(<Button text="Button" title="Custom Title" />);
  expect(button).toMatchSnapshot();
});
...
it('should render an icon only button with a custom accessible label', () => {
  const button = enzyme.shallow(<Button isIconOnly text="Icon Only" aria-label="Custom Accessible Label" />);
  expect(button).toMatchSnapshot();
});
...
it('should render a utility button with a custom accessible label', () => {
  const button = enzyme.shallow(<Button variant="utility" text="Icon Only" aria-label="Custom Accessible Label" />);
  expect(button).toMatchSnapshot();
});

it('should render a button with accessible label', () => {
  const button = enzyme.shallow(<Button text="Button" aria-label="Custom Accessible Label" />);
  expect(button).toMatchSnapshot();
});

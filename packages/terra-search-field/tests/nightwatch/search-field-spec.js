...
module.exports = resizeTo(['medium'], {
  'Displays a search field with search button': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/default-search-field`);
  ...
  'Displays a search field with a placeholder value of "Search Text"': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/placeholder-search-field`);
  ...
  'Displays a search field that handles search callbacks': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/callback-search-field`);
  ...
  'Displays a search field with a search delay of 1000': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/delayed-search-field`);
  ...
  'Displays a search field with a minimum search text length of 5 characters': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/minimum-length-search-field`);
  ...
  'Displays a search field with a default value': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-default-value`);
  ...
  'Displays a search field with a consumer onchange handler': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-on-change`);
  ...
  'Displays a search field with a value': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-with-value`);
  ...
  'Displays a search field that is disabled': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-disabled`);
  ...
  'Displays a search field displayed as block style to fill its container': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-block`);
  ...
  'Displays the search field and disables the auto searching ': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/auto-search-disabled-search-field`);
  ...
  'Displays the search field with auto searching on and handles ENTER keypress to search ': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-search-field/search-field/search-field-enter`);

...
module.exports = resizeTo(['medium'], {
  'Displays a default toggle-button': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/default-toggle-button`)
      .assert.elementPresent('#toggleButton');
  },

  'Displays a toggle-button with customized button': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/customized-button-toggle-button`)
      .assert.elementPresent('#emphasisButton');
  },

  'Displays a toggle-button with customized closedButtonText': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/closed-button-text`)
  ...
  'Displays a toggle-button with customized icon': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/custom-icon`)
      .assert.elementPresent('#custom-icon');
  },

  'Displays an animated toggle-button': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/animated`)
      .assert.elementPresent('#animatedToggle');
  },

  'Displays a toggle-button with animated icon': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/icon-animated`)
      .assert.elementPresent('#animatedIcon');
  },

  'Displays an icon only toggle-button': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/icon-only`)
  ...
  'Displays an initially open toggle-button': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/initially-open`)
  ...
  'Displays a toggle-button with customized openedButtonText': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/opened-button-text`)
  ...
  'Triggers onOpen callback for ToggleButton when button is selected': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/on-open-toggle-button`);
  ...
  'Triggers onClose callback for ToggleButton when button is selected': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/terra-toggle-button/toggle-button/on-close-toggle-button`);

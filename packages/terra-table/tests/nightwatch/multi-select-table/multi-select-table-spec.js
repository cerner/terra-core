...
module.exports = resizeTo(['tiny', 'huge'], {
  ...
  'Displays a default selectable table': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table`)
  ...
  'Display a selectable table and highlights the selected row upon clicking': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table`);
  ...
  'Triggers onChange for selectable table upon clicking a row': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-on-change`);
  ...
  'Displays a selectable table with a preselected row': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-preselected`);
    expectRowIsSelected(0);
    expectRowIsNotSelected(1);
    expectRowIsNotSelected(2);
  },
  ...
  'Displays a selectable table with a non-selectable row': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-non-selectable`);
    expectRowIsNotSelected(0);
  },

  'Displays a selectable table with a max selection count honored on click': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-max-count`);
  ...
  'Displays a initially met max count selectable table with a max selection count honored on click': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-max-count-initially-met`);
  ...
  'Displays an initially exceeded max count selectable table with correctly selected rows': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table/multi-select-table/components/multi-row-selectable-table-max-count-initially-exceeded`);

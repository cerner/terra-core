...
module.exports = resizeTo(['tiny', 'huge'], {
  ...
  'Displays a table with only one row': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table-tests/single-row`);
  ...
  'Displays a table with no rows': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/table-tests/no-rows`);

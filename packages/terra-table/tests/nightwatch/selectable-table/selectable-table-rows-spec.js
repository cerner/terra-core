...
module.exports = resizeTo(['medium'], {
  'Displays a default table with the provided text': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-default`)
      .expect.element('#Table').to.be.present;
  },

  'Displays a selectable table with a subheader': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-and-subheaders`);
  ...
  'Display a selectable table with preselected rows': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-preselected`);
  ...
  'Displays a selectable table with non-selectable rows': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-non-selectable`);
  ...
  'Triggers onChange for selectable table upon selecting a row': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-on-change`);
  ...
  'Displays a selectable table with only one row': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-one-row`);
  ...
  'Displays a selectable table with no rows': (browser) => {
    browser.url(`${browser.launchUrl}/#/raw/tests/table/selectable-table/selectable-table-rows-no-rows`)

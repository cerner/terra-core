...
const TableWithHighlightedRows = () => (
  <Table isStriped={false}>
    ...
    <Table.Rows>
      ...
      <Table.Row isSelected key={shortid.generate()}>
        <Table.RowContent content={'Row 4 Cell 1'} key={shortid.generate()} />
        <Table.RowContent content={'Row 4 Cell 2'} key={shortid.generate()} />
        <Table.RowContent content={'Row 4 Cell 3'} key={shortid.generate()} />
      </Table.Row>
      <Table.Row key={shortid.generate()}>
        <Table.RowContent content={'Row 5 Cell 1'} key={shortid.generate()} />
        <Table.RowContent content={'Row 5 Cell 2'} key={shortid.generate()} />
        <Table.RowContent content={'Row 5 Cell 3'} key={shortid.generate()} />
      </Table.Row>
    </Table.Rows>
  </Table>
);

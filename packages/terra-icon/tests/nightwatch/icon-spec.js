...
module.exports = resizeTo(['tiny', 'huge'], {
  'Displays a default icon with aria-hidden equal to true': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/icon/components/icon-default`)
  ...
  'Displays an icon with an appended css class': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/icon/components/icon-append-class`)
  ...
  'Displays icon example where the ariaLabel is given': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/icon/components/icon-aria`)
  ...
  'Displays icon height and width examples': (browser) => {
    browser
      .url(`${browser.launchUrl}/#/tests/icon/components/icon-height-width`)
  ...
  'Displays icon bidirectionality examples': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/icon/components/icon-bidi`);
  },
});

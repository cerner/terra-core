...
const outputfile = fs.createWriteStream('../../packages/terra-core-docs/src/terra-dev-site/doc/icon/example/IconStatic.jsx', { flags: 'w' });

const generateIconAll = iconObjs => new Promise((resolve) => {

  const staticIcons = iconObjs.filter(iconObj => !iconObj.themeable && !iconObj.deprecated && !iconObj.isOldLowlight);

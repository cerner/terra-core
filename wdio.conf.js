...
if (process.env.npm_package_name !== 'terra-core') {
  ...
  wdioConfig.specs = [
    ...
    path.join(__dirname, 'packages', 'terra-form-select', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-form-textarea', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-grid', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-heading', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-html-table', 'tests', 'wdio', '**', '*-spec.js'),
    ...
    path.join(__dirname, 'packages', 'terra-html-table', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-hyperlink', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-i18n', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-icon', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-image', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-list', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-overlay', 'tests', 'wdio', '**', '*-spec.js'),
    ...
    path.join(__dirname, 'packages', 'terra-spacer', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-status', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-status-view', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-switch', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-table', 'tests', 'wdio', '**', '*-spec.js'),
    ...
    path.join(__dirname, 'packages', 'terra-toolbar', 'tests', 'wdio', '**', '*-spec.js'),
    path.join(__dirname, 'packages', 'terra-visually-hidden-text', 'tests', 'wdio', '**', '*-spec.js'),
  ];
}
